...
=========
   ...
   +==============+=============+===================================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/namedtupledefs2      |
   +--------------+-------------+---------------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/namedtupledefs2/ |
   +--------------+-------------+---------------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/namedtupledefs2/       |
   +--------------+-------------+---------------------------------------------------+
   | Documents    | sourceforge | https://namedtupledefs2.sourceforge.io/           |
   +--------------+-------------+---------------------------------------------------+
