...
Original Code
=============
Same as the original license.
Here as provided by the standard library *collections*.

Patches Integrated into Python Standard Library Collections
===========================================================
When integrated into the original standard library the license of the original
library.

Patches By This Package
=======================
...
When downloaded as a separate library - this package, the following applies.
